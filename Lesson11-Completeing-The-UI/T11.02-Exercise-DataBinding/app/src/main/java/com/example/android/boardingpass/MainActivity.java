...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long remainingHours = TimeUnit.MINUTES.toHours(minsUntilBoarding);
        long remainingMins = minsUntilBoarding - TimeUnit.HOURS.toMinutes(remainingHours);

        String countDownString = remainingHours + ":" + remainingMins;
        mBinding.textViewBoardingInCountdown.setText(countDownString);
