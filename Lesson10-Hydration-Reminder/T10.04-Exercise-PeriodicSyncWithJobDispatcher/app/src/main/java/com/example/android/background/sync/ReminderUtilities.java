...
public class ReminderUtilities {
    private static final int REMINDER_INTERVAL_SECONDS = 15;//(int) TimeUnit.MINUTES.toSeconds(1);
    ...
    synchronized public static void scheduleChargingReminder(Context context) {
        ...
        Job contrainedJob = dispatcher.newJobBuilder()
                ...
                .build();
        dispatcher.schedule(contrainedJob);
        sInitialized = true;
    }
}
