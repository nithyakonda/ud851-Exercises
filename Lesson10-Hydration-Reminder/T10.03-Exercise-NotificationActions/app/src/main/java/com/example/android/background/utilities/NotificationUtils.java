...
public class NotificationUtils {
    ...
    private static final int IGNORE_ACTION_INTENT_ID = 2341;

    private static final int INCREMENT_WATER_COUNT_ACTION_INTENT_ID = 8744;
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                INCREMENT_WATER_COUNT_ACTION_INTENT_ID,
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                "Yes, I did it!",
